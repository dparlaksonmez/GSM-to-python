...
Example Usage:
    python scripts/run_gl_all_datasets.py
    python scripts/run_gl_all_datasets.py --n-iterations 5
    python scripts/run_gl_all_datasets.py --datasets GDS1962 GDS2545
"""
