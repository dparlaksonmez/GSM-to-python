...
Usage:
    python scripts/seed_stability_experiment.py
    python scripts/seed_stability_experiment.py --datasets GDS2545 GDS3257
    python scripts/seed_stability_experiment.py --seeds 44 88 132 176
