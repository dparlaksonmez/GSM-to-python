...
Usage:
    ...
    python scripts/manuscript_changelog.py

    # Compare specific versions:
    python scripts/manuscript_changelog.py --old v33 --new v34

    # Save to file instead of stdout:
    python scripts/manuscript_changelog.py --output changelog.md
