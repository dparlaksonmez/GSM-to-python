...
Usage:
    python scripts/finalize_publication.py
    python scripts/finalize_publication.py --skip-move      # don't reorganise outputs
    python scripts/finalize_publication.py --skip-manuscript # don't rebuild docx
"""
...
def run_analysis():
    ...
    script = project_root / "scripts" / "analyze_manuscript_results.py"
    print(f"\n📊 Running {script.name}...")
...
def run_baseline_figure():
    ...
    script = project_root / "scripts" / "generate_baseline_comparison.py"
...
def update_presentation():
    ...
    tex_path = (
        project_root / "reports_ARCHIVE" / "presentation"
