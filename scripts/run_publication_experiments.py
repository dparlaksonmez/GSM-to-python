...
Usage:
    python scripts/run_publication_experiments.py                 # run all
    python scripts/run_publication_experiments.py --skip-main     # skip main
    python scripts/run_publication_experiments.py --only baselines sensitivity
...
def main():
    ...
    if should_run("main"):
        experiments.append((
            ...
            [py, str(SCRIPTS_DIR / "run_all_datasets.py"),
    ...
    if should_run("seed"):
        experiments.append((
            ...
            [py, str(SCRIPTS_DIR / "seed_stability_experiment.py")],
        ))

    if should_run("analyze"):
        experiments.append((
            "Analyze Results → manuscript_data.json + figures",
            [py, str(SCRIPTS_DIR / "analyze_manuscript_results.py")],
        ))
